...
userID = "kosilov_water" # 自分のAtCoderのユーザーIDを設定する
unix_second = 0
# api_path = "https://kenkoooo.com/atcoder/atcoder-api/v3/user/submissions?user=" + userID + "&from_second=" + str(unix_second)
# 旧APIだと正常に動く。なぜ
api_path = "https://kenkoooo.com/atcoder/atcoder-api/results?user=kosilov_water"
...
if add_cnt == 0:
    ...
    # 自分のリポジトリのURL+".git"
    repo_url = "https://github.com/kosirobwada/AtCoderSubmit.git"
    repo = git.Repo()
